...
# 🎮 Water You Doing? — Community Edition

**Pipe, pour, and puzzle your way through liquid physics.**
...
Water You Doing? is a physics-based puzzle game centered on controlling and redirecting water flow across increasingly complex levels. Players manipulate pipes, valves, and terrain to guide liquid to its target while managing pressure and volume. This Community Edition is a standalone build distributed as a self-contained package: no storefront, no additional software, ready to play immediately after extraction.

This standalone build is intended for players who want a self-contained offline version of a casual water-physics puzzle game.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4429930/736dc1232df816c0ed7bc07336d1692dbbf33815/ss_736dc1232df816c0ed7bc07336d1692dbbf33815.1920x1080.jpg?t=1788260021" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4429930/0459e32a1432f4a102d8418390194a06e038a292/ss_0459e32a1432f4a102d8418390194a06e038a292.1920x1080.jpg?t=1788260021" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/4429930/1a5e2910ad4b194a7ec2f97bd9009c7316ab0dbb/ss_1a5e2910ad4b194a7ec2f97bd9009c7316ab0dbb.1920x1080.jpg?t=1788260021" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- 💧 **Fluid Physics** — Realistic water simulation with pressure, flow, and volume mechanics.
- 🧩 **Handcrafted Levels** — Dozens of stages introducing new mechanics like valves, splitters, and reservoirs.
- 🔧 **Pipe Building** — Construct and reroute pipe networks to solve each layout.
- ⭐ **Rating System** — Earn stars based on water efficiency and completion time.
- 🎮 **Simple Controls** — Point-and-click interface accessible to all skill levels.
- 💾 **Progress Saving** — Automatic save system preserves level progress between sessions.
- 🖥️ **Offline Play** — Fully playable offline as an independent release.
- 📦 **Self-Contained** — Single package with all content included, no extra downloads.
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD Graphics 4000 / NVIDIA GeForce GTX 650 | NVIDIA GeForce GTX 1050 / AMD Radeon RX 560 |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\WaterYouDoing?\Saved`
